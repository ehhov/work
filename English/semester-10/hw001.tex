...
the products of the refractive index and the falling angle sine, so 
there may be situations when for light to propagate to the other medium 
the value of sine has to be greater than unity. It means that the light 
does not propagate to the other medium and is entirely reflected back 
into the first one. This way the light can stay within a medium with 
a larger refractive index even when it is bent. It was first observed in 
water when rays of light followed its flow.
